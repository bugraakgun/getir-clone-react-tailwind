...
function MobileApp() {
  return (
    <div className='container flex md:flex-row flex-col items-center  justify-between mx-auto bg-mobile-app pt-10 md:pl-10 bg-primary-brand-color mt-5 rounded-lg text-white'>
